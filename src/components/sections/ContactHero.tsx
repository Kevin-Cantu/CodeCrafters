    ...
    <section className="relative isolate pt-24 pb-16 sm:pt-28 sm:pb-20 md:pt-32 md:pb-24 overflow-hidden  ">
      ...
      <div className="container-custom relative z-10">
        <motion.div className="text-center max-w-4xl mx-auto" variants={stagger} initial="hidden" animate="show">
          ...
          <motion.h1 className="sm:mt-6  mt-24 text-4xl sm:text-5xl md:text-6xl font-semibold tracking-tight text-white" variants={fadeInUp(0.05)}>
            Construyamos algo extraordinario
          </motion.h1>

          <motion.p className="mt-16 sm:mt-12 text-lg md:text-xl leading-relaxed text-slate-300" variants={fadeInUp(0.1)}>
          ...
          <motion.div className="mt-16 flex flex-col sm:flex-row items-center justify-center gap-4" variants={fadeInUp(0.15)}>
          <a
  href="#contacto-form"
  onClick={(e) => {
    e.preventDefault();
    ...
    if (!el) return;
    const offset = 160; // Ajusta a la altura de tu navbar
...
>
  ...
  >
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M17 8l4 4m0 0l-4 4m4-4H3" />
          ...
          <motion.div className="mt-16  sm:-mb-16 flex flex-wrap items-center justify-center gap-x-3 gap-y-3 text-slate-400 text-sm" variants={fadeInUp(0.2)}>
