...
const DummyContent = ({
  ...
  return (
    <div className="bg-gradient-to-br from-white to-gray-50 dark:from-neutral-900 dark:to-neutral-800 p-8 md:p-14 rounded-3xl mb-4 border border-gray-100 dark:border-neutral-700 shadow-xl">
      <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {features.map((feature, index) => (
              <div key={index} className="flex items-center text-gray-700 dark:text-gray-300">
                <svg className="w-5 h-5 mr-3 text-green-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
  ...
  },
  {
    ...
    content: (
      <DummyContent
        ...
        carousel={<div className="text-center text-gray-500 py-8">Stack móvil próximamente disponible</div>}
      />
    ),
  },
  {
    ...
    content: (
      <DummyContent
        ...
        carousel={<div className="text-center text-gray-500 py-8">Showcase de interfaces próximamente</div>}
      />
    ),
  },
  {
    ...
    content: (
      <DummyContent
        ...
        carousel={<div className="text-center text-gray-500 py-8">Diagrama de arquitectura próximamente</div>}
      />
    ),
  },
  {
    ...
    content: (
      <DummyContent
        ...
        carousel={<div className="text-center text-gray-500 py-8">Mockups iOS próximamente disponibles</div>}
      />
    ),
  },
];